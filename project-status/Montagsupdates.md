 ...
 * Eine unserer Tabellen hatte recht knapp bemessene Spaltenbreiten für `trip_id`, `route_id` und `stop_id`, die von einer neune Datenquelle teilweise um Faktor 4 übertroffen wurden.
 ...
 * Bisher musste eine neue Dystonse-Instanz einige Tage oder Wochen laufen, bis genug Echtzeitdaten gesammelt sind, um daraus nützliche Prognosen abzuleiten. Um diese Hürde etwas abzumildern, haben wir einen kleinen Workaround geschaffen:
   ...
   * Wir haben [Anweisungen](https://github.com/dystonse/dystonse-docker#set-up-default-statistics-for-quick-start) geschrieben, wie diese Daten einzubinden sind. Der Vorgang ist nämlich (noch?) nicht automatisiert.
